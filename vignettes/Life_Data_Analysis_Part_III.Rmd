...
The only difference is that one has to change the default of the argument `direction` to `"x"`. 
...
# Visualization: 
## Beta-Binomial confidence intervals: 
weibull_conf_bb_x <- plot_conf(weibull_grid, conf_bb_x)
weibull_conf_bb_x

## Fisher's normal approximation confidence intervals:
weibull_conf_fisher_x <- plot_conf(weibull_grid, conf_fisher_x)
