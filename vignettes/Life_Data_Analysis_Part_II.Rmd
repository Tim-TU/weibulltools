...
distributions. Where _Rank Regression (RR)_ fits a straight line through 
...
```{r RR weibull, fig.cap = "Figure 1: RR for a two-parametric Weibull distribution.", message = FALSE}
...
```{r ML weibull, fig.cap = "Figure 2: ML for a two-parametric Weibull distribution.", message = FALSE}
...
```{r ML visualization I, fig.cap = "Figure 3: ML for a two-parametric log-normal distribution.", message = FALSE}
...
```{r ML visualization II, fig.cap = "Figure 4: ML for a three-parametric log-normal distribution.", message = FALSE}
