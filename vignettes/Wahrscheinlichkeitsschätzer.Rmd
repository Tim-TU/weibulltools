...
Testet man alle Einheiten _n_ einer Stichprobe bis zu ihrem Aufall, kann man die Lebensdauer jeder Einheit genau bestimmen. Die Lebensdauer kann in diesem Fall zum Beispiel die Zeit bis zum Ausfall, die zurückgelegte Distanz oder die Anzahl der Lastzyklen sein.  
...
Diese nicht-parametrische Approximation wird benutzt, um Ausfallwahrscheinlichkeiten zu schätzen, wenn rechtszensierte Daten vorliegen.
